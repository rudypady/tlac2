...
const translations = {
    sk: {
        ...
        'setting-print-mode': 'Režim tlače',
        'print-mode-browser': 'Prehliadač (štandardný)',
        'print-mode-direct': 'Priama tlač na tlačiareň',
        'print-mode-help': 'Priama tlač umožňuje tiché tlačenie bez dialógových okien prehliadača.',
        'printer-settings-title': 'Nastavenia tlačiarní',
        'default-printer': 'Predvolená tlačiareň',
        'no-printer-selected': 'Žiadna tlačiareň',
        'printer-management-title': 'Správa tlačiarní',
        'printer-name': 'Názov tlačiarne',
        'printer-name-placeholder': 'Zebra ZT410',
        'printer-ip': 'IP adresa',
        'printer-ip-placeholder': '192.168.1.100',
        'printer-port': 'Port',
        'printer-format': 'Formát tlače',
        'format-zpl': 'ZPL (Zebra)',
        'format-epl': 'EPL (Eltron)',
        'format-raw': 'Raw Commands',
        'btn-add-printer': 'Pridať tlačiareň',
        'btn-test-printer': 'Testovať pripojenie',
        'configured-printers': 'Nakonfigurované tlačiarne',
        'no-printers': 'Žiadne nakonfigurované tlačiarne',
        'select-printer': 'Vybrať tlačiareň',
        'btn-direct-print': 'Priama tlač',
        'btn-generate-zpl': 'Vygenerovať ZPL',
    ...
    en: {
        ...
        'setting-print-mode': 'Print mode',
        'print-mode-browser': 'Browser (standard)',
        'print-mode-direct': 'Direct printer communication',
        'print-mode-help': 'Direct printing allows silent printing without browser dialogs.',
        'printer-settings-title': 'Printer Settings',
        'default-printer': 'Default printer',
        'no-printer-selected': 'No printer selected',
        'printer-management-title': 'Printer Management',
        'printer-name': 'Printer name',
        'printer-name-placeholder': 'Zebra ZT410',
        'printer-ip': 'IP address',
        'printer-ip-placeholder': '192.168.1.100',
        'printer-port': 'Port',
        'printer-format': 'Print format',
        'format-zpl': 'ZPL (Zebra)',
        'format-epl': 'EPL (Eltron)',
        'format-raw': 'Raw Commands',
        'btn-add-printer': 'Add printer',
        'btn-test-printer': 'Test connection',
        'configured-printers': 'Configured printers',
        'no-printers': 'No configured printers',
        'select-printer': 'Select printer',
        'btn-direct-print': 'Direct print',
        'btn-generate-zpl': 'Generate ZPL',
